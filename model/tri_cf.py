...
class TriCF(MF):
	...
	def build_user_item_sim_CF(self):
		...
		#寻找用户的k近邻
		self.user_k_neibor=util.load_data('../data/neibor/ft_08_uu_'+str(self.config.user_near_num)+'_neibor_tricf.pkl')
		...
		#寻找项目的k近邻
		self.item_k_neibor=util.load_data('../data/neibor/ft_08_ii_'+str(self.config.item_near_num)+'_neibor_tricf.pkl')
